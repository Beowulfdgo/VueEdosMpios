new Vue({
  el: '#app',
  data: {
    estados2: ["AGUASCALIENTES", "BAJA CALIFORNIA"],

    selected:"AGUASCALIENTES",
    estados: [{ clave : 'AGS' , descripcion : 'AGUASCALIENTES' },
    ...
    { clave : 'BCS' , descripcion : 'BAJA CALIFORNIA SUR' },
        ...
        { clave : 'CMX' , descripcion : 'DISTRITO FEDERAL' },
  ...
  methods:{
    crearestado(){
      alert("el estado fue creado");
      this.estados2.unshift(this.selected);
    },
    borrarestados(index){
      alert("el estado se eliminara");
      this.estados2.splice(index,1);
    }
  },
  computed: {
    nombreYapellidos() {
      return this.nombre + " " + this.apellidos + " " + this.nota;
    },
    }
 });